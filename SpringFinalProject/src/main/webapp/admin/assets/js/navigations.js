function listNavigations(){
	...
	$.ajax({
		url: "../../SpringFinalProject/navigations/",
		type: 'GET',
		dataType : "json",
    contentType: "application/json",
  	...
  	$.each(response, function(key, value) {
  		...
  		"</td><a href = '#' onclick=deleteNavModal('"+value.navigationID+"','"+encodeURIComponent(value.navigationName)+"') data-toggle='tooltip' title='Delete'><span class='fa fa-trash-alt' aria-hidden='true'></span><span class='sr-only'>Delete</span></a>" +
...
function getNavigation(navigationID) {
    ...
    $.ajax({
        url: "../../SpringFinalProject/navigations/" + navigationID,
        type: 'GET',
        dataType: "json",
        contentType: "application/json",
    }).fail(function(response) {
