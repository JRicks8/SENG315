...
function listArticles(){
	...
	var heading = "<h1 class='my-4''>Want to Read?<small>Came To the Right Place</small></h1>"

	$.ajax({
		url: "../SENG315FinalProjectAPIs/rest/articles/",
		type: 'GET',
		dataType : "json",
    	...
    	$.each(response, function(key, value) {
            ...
            "<div class='card-body'>" +
              ...
              "<a href='./index.jsp?view=article&articleID="+value.articleID+"' class='btn btn-primary'>Read More &rarr;</a>" +
            "</div>" +
